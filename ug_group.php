...
$nonAdminTablesArr[] = "tickets";
$nonAdminTablesArr[] = "tickets_proyectos";
$nonAdminTablesArr[] = "tickets_tipo";
$nonAdminTablesArr[] = "tickets_prioridad";
$nonAdminTablesArr[] = "camerfirma_104_users";
$nonAdminTablesArr[] = "camerfirma_104_users_gestion";
$nonAdminTablesArr[] = "certificados_tipo";
$nonAdminTablesArr[] = "tp_certificados";
$nonAdminTablesArr[] = "token_tipo";
$nonAdminTablesArr[] = "tp_token";
$nonAdminTablesArr[] = "certificados_solicitud";
$nonAdminTablesArr[] = "q_divipola";
$nonAdminTablesArr[] = "tp_certificados_anexos";
$nonAdminTablesArr[] = "camerfirma_104_users_q";
$nonAdminTablesArr[] = "certificados_tipo_q";
$nonAdminTablesArr[] = "tp_vigencia";
$nonAdminTablesArr[] = "tp_stage";
$nonAdminTablesArr[] = "token_tipo_q";
$nonAdminTablesArr[] = "tp_tipodocident";
$nonAdminTablesArr[] = "certificados_solicitud_tr_0";
$nonAdminTablesArr[] = "certificados_solicitud_track";
$nonAdminTablesArr[] = "certificados_solicitud_tr_1";
$nonAdminTablesArr[] = "certificados_solicitud_tr_2";
$nonAdminTablesArr[] = "certificados_solicitud_tr_3";
$nonAdminTablesArr[] = "certificados_solicitud_tr_4";
$nonAdminTablesArr[] = "certificados_solicitud_tr_5";
$nonAdminTablesArr[] = "certificados_solicitud_tr_6";
$nonAdminTablesArr[] = "tp_stage_tk";
$nonAdminTablesArr[] = "q_group_tipotoken_chart";
$nonAdminTablesArr[] = "certificados_solicitud Report";
$nonAdminTablesArr[] = "dependencia_tipo";
$nonAdminTablesArr[] = "dependencia_tipo_user";
...
$wGroupTableName = $ug_connection->addTableWrappers( "camerfirma_104_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "camerfirma_104_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "camerfirma_104_ugrights" );
