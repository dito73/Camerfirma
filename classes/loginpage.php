...
class LoginPage extends RunnerPage
{
	...
	protected function sendTwoFactorCode()
	{
		...
		if( !$ret["success"] )
		{
			$this->message = "el envío de mensajes de error"." ".$ret["message"];
	...
	protected function assignBody()
	{
		...
		$this->body["end"] .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/runnerJS/RunnerAll.js?40606")."\"></script>";
