	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("camerfirma_104_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "mail_messages" ] = array( "url" => "mail_messages", "type" => 0 );
	$projectEntitiesReverse[ "mail_messages" ] = "mail_messages";
	$projectEntities[ "tickets" ] = array( "url" => "tickets", "type" => 0 );
	$projectEntitiesReverse[ "tickets" ] = "tickets";
	$projectEntities[ "tickets_proyectos" ] = array( "url" => "tickets_proyectos", "type" => 0 );
	$projectEntitiesReverse[ "tickets_proyectos" ] = "tickets_proyectos";
	$projectEntities[ "tickets_tipo" ] = array( "url" => "tickets_tipo", "type" => 0 );
	$projectEntitiesReverse[ "tickets_tipo" ] = "tickets_tipo";
	$projectEntities[ "tickets_prioridad" ] = array( "url" => "tickets_prioridad", "type" => 0 );
	$projectEntitiesReverse[ "tickets_prioridad" ] = "tickets_prioridad";
	$projectEntities[ "camerfirma_104_users" ] = array( "url" => "camerfirma_104_users", "type" => 0 );
	$projectEntitiesReverse[ "camerfirma_104_users" ] = "camerfirma_104_users";
	...
	$projectEntities[ "camerfirma_104_users_gestion" ] = array( "url" => "camerfirma_104_users_gestion", "type" => 1 );
	$projectEntitiesReverse[ "camerfirma_104_users_gestion" ] = "camerfirma_104_users_gestion";
	$projectEntities[ "certificados_tipo" ] = array( "url" => "certificados_tipo", "type" => 0 );
	$projectEntitiesReverse[ "certificados_tipo" ] = "certificados_tipo";
	$projectEntities[ "tp_certificados" ] = array( "url" => "tp_certificados", "type" => 0 );
	$projectEntitiesReverse[ "tp_certificados" ] = "tp_certificados";
	$projectEntities[ "token_tipo" ] = array( "url" => "token_tipo", "type" => 0 );
	$projectEntitiesReverse[ "token_tipo" ] = "token_tipo";
	$projectEntities[ "tp_token" ] = array( "url" => "tp_token", "type" => 0 );
	$projectEntitiesReverse[ "tp_token" ] = "tp_token";
	$projectEntities[ "certificados_solicitud" ] = array( "url" => "certificados_solicitud", "type" => 0 );
	$projectEntitiesReverse[ "certificados_solicitud" ] = "certificados_solicitud";
	$projectEntities[ "q_divipola" ] = array( "url" => "q_divipola", "type" => 0 );
	$projectEntitiesReverse[ "q_divipola" ] = "q_divipola";
	$projectEntities[ "tp_certificados_anexos" ] = array( "url" => "tp_certificados_anexos", "type" => 0 );
	$projectEntitiesReverse[ "tp_certificados_anexos" ] = "tp_certificados_anexos";
	$projectEntities[ "camerfirma_104_users_q" ] = array( "url" => "camerfirma_104_users_q", "type" => 1 );
	$projectEntitiesReverse[ "camerfirma_104_users_q" ] = "camerfirma_104_users_q";
	$projectEntities[ "certificados_tipo_q" ] = array( "url" => "certificados_tipo_q", "type" => 1 );
	$projectEntitiesReverse[ "certificados_tipo_q" ] = "certificados_tipo_q";
	$projectEntities[ "tp_vigencia" ] = array( "url" => "tp_vigencia", "type" => 0 );
	$projectEntitiesReverse[ "tp_vigencia" ] = "tp_vigencia";
	$projectEntities[ "tp_stage" ] = array( "url" => "tp_stage", "type" => 0 );
	$projectEntitiesReverse[ "tp_stage" ] = "tp_stage";
	$projectEntities[ "token_tipo_q" ] = array( "url" => "token_tipo_q", "type" => 1 );
	$projectEntitiesReverse[ "token_tipo_q" ] = "token_tipo_q";
	$projectEntities[ "tp_tipodocident" ] = array( "url" => "tp_tipodocident", "type" => 0 );
	$projectEntitiesReverse[ "tp_tipodocident" ] = "tp_tipodocident";
	$projectEntities[ "certificados_solicitud_tr_0" ] = array( "url" => "certificados_solicitud_tr_0", "type" => 1 );
	$projectEntitiesReverse[ "certificados_solicitud_tr_0" ] = "certificados_solicitud_tr_0";
	$projectEntities[ "certificados_solicitud_track" ] = array( "url" => "certificados_solicitud_track", "type" => 0 );
	$projectEntitiesReverse[ "certificados_solicitud_track" ] = "certificados_solicitud_track";
	$projectEntities[ "certificados_solicitud_tr_1" ] = array( "url" => "certificados_solicitud_tr_1", "type" => 1 );
	$projectEntitiesReverse[ "certificados_solicitud_tr_1" ] = "certificados_solicitud_tr_1";
	$projectEntities[ "certificados_solicitud_tr_2" ] = array( "url" => "certificados_solicitud_tr_2", "type" => 1 );
	$projectEntitiesReverse[ "certificados_solicitud_tr_2" ] = "certificados_solicitud_tr_2";
	$projectEntities[ "certificados_solicitud_tr_3" ] = array( "url" => "certificados_solicitud_tr_3", "type" => 1 );
	$projectEntitiesReverse[ "certificados_solicitud_tr_3" ] = "certificados_solicitud_tr_3";
	$projectEntities[ "certificados_solicitud_tr_4" ] = array( "url" => "certificados_solicitud_tr_4", "type" => 1 );
	$projectEntitiesReverse[ "certificados_solicitud_tr_4" ] = "certificados_solicitud_tr_4";
	$projectEntities[ "certificados_solicitud_tr_5" ] = array( "url" => "certificados_solicitud_tr_5", "type" => 1 );
	$projectEntitiesReverse[ "certificados_solicitud_tr_5" ] = "certificados_solicitud_tr_5";
	$projectEntities[ "certificados_solicitud_tr_6" ] = array( "url" => "certificados_solicitud_tr_6", "type" => 1 );
	$projectEntitiesReverse[ "certificados_solicitud_tr_6" ] = "certificados_solicitud_tr_6";
	$projectEntities[ "tp_stage_tk" ] = array( "url" => "tp_stage_tk", "type" => 0 );
	$projectEntitiesReverse[ "tp_stage_tk" ] = "tp_stage_tk";
	$projectEntities[ "q_group_tipotoken_chart" ] = array( "url" => "q_group_tipotoken_chart", "type" => 3 );
	$projectEntitiesReverse[ "q_group_tipotoken_chart" ] = "q_group_tipotoken_chart";
	$projectEntities[ "certificados_solicitud Report" ] = array( "url" => "certificados_solicitud_report", "type" => 2 );
	$projectEntitiesReverse[ "certificados_solicitud_report" ] = "certificados_solicitud Report";
	$projectEntities[ "dependencia_tipo" ] = array( "url" => "dependencia_tipo", "type" => 0 );
	$projectEntitiesReverse[ "dependencia_tipo" ] = "dependencia_tipo";
	$projectEntities[ "dependencia_tipo_user" ] = array( "url" => "dependencia_tipo_user", "type" => 1 );
	$projectEntitiesReverse[ "dependencia_tipo_user" ] = "dependencia_tipo_user";
}
