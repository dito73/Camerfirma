...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("mail_messages" == $this->chrt_array['tables'][0])
			return true;
		if("tickets" == $this->chrt_array['tables'][0])
			return true;
		if("tickets_proyectos" == $this->chrt_array['tables'][0])
			return true;
		if("tickets_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("tickets_prioridad" == $this->chrt_array['tables'][0])
			return true;
		if("camerfirma_104_users" == $this->chrt_array['tables'][0])
			return true;
		if("camerfirma_104_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("camerfirma_104_users" == $this->chrt_array['tables'][0])
			return true;
		if("camerfirma_104_users" == $this->chrt_array['tables'][0])
		...
		if("camerfirma_104_users" == $this->chrt_array['tables'][0])
			return true;
		if("certificados_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("tp_certificados" == $this->chrt_array['tables'][0])
			return true;
		if("token_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("tp_token" == $this->chrt_array['tables'][0])
			return true;
		if("certificados_solicitud" == $this->chrt_array['tables'][0])
			return true;
		if("q_divipola" == $this->chrt_array['tables'][0])
			return true;
		if("tp_certificados_anexos" == $this->chrt_array['tables'][0])
			return true;
		if("camerfirma_104_users" == $this->chrt_array['tables'][0])
			return true;
		if("certificados_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("tp_vigencia" == $this->chrt_array['tables'][0])
			return true;
		if("tp_stage" == $this->chrt_array['tables'][0])
			return true;
		if("token_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("tp_tipodocident" == $this->chrt_array['tables'][0])
			return true;
		if("certificados_solicitud" == $this->chrt_array['tables'][0])
			return true;
		if("certificados_solicitud_track" == $this->chrt_array['tables'][0])
			return true;
		if("certificados_solicitud" == $this->chrt_array['tables'][0])
			return true;
		if("certificados_solicitud" == $this->chrt_array['tables'][0])
		...
		if("certificados_solicitud" == $this->chrt_array['tables'][0])
			return true;
		if("tp_stage_tk" == $this->chrt_array['tables'][0])
			return true;
		if("q_group_tipotoken" == $this->chrt_array['tables'][0])
			return true;
		if("certificados_solicitud" == $this->chrt_array['tables'][0])
			return true;
		if("dependencia_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("dependencia_tipo" == $this->chrt_array['tables'][0])
			return true;
		return false;
