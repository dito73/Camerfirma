...
{
	$value = "";
				if($table=="tickets" && $field=="archivos")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud" && $field=="doc_acta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud" && $field=="doc_carta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud" && $field=="doc_certificado")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud" && $field=="doc_poder")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud" && $field=="doc_rut")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud" && $field=="doc_cedula")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud" && $field=="doc_escritura")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_0" && $field=="doc_acta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_0" && $field=="doc_carta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_0" && $field=="doc_certificado")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_0" && $field=="doc_poder")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_0" && $field=="doc_rut")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_0" && $field=="doc_cedula")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_0" && $field=="doc_escritura")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_1" && $field=="doc_acta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_1" && $field=="doc_carta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_1" && $field=="doc_certificado")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_1" && $field=="doc_poder")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_1" && $field=="doc_rut")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_1" && $field=="doc_cedula")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_1" && $field=="doc_escritura")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_2" && $field=="doc_acta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_2" && $field=="doc_carta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_2" && $field=="doc_certificado")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_2" && $field=="doc_poder")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_2" && $field=="doc_rut")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_2" && $field=="doc_cedula")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_2" && $field=="doc_escritura")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_3" && $field=="doc_acta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_3" && $field=="doc_carta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_3" && $field=="doc_certificado")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_3" && $field=="doc_poder")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_3" && $field=="doc_rut")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_3" && $field=="doc_cedula")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_3" && $field=="doc_escritura")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_4" && $field=="doc_acta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_4" && $field=="doc_carta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_4" && $field=="doc_certificado")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_4" && $field=="doc_poder")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_4" && $field=="doc_rut")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_4" && $field=="doc_cedula")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_4" && $field=="doc_escritura")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_5" && $field=="doc_acta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_5" && $field=="doc_carta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_5" && $field=="doc_certificado")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_5" && $field=="doc_poder")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_5" && $field=="doc_rut")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_5" && $field=="doc_cedula")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_5" && $field=="doc_escritura")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_6" && $field=="doc_acta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_6" && $field=="doc_carta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_6" && $field=="doc_certificado")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_6" && $field=="doc_poder")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_6" && $field=="doc_rut")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_6" && $field=="doc_cedula")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud_tr_6" && $field=="doc_escritura")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud Report" && $field=="doc_acta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud Report" && $field=="doc_carta")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud Report" && $field=="doc_certificado")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud Report" && $field=="doc_poder")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud Report" && $field=="doc_rut")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud Report" && $field=="doc_cedula")
	{
		;
		return $value;
	}
				if($table=="certificados_solicitud Report" && $field=="doc_escritura")
	{
		;
		return $value;
	}
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
		if($table=="certificados_solicitud" && $field=="stage")
	{
		$strWhere = " stage_id = 1";
		return $strWhere;
	}
		if($table=="certificados_solicitud_tr_1" && $field=="stage")
	{
		$strWhere = " stage_group = 2";
		return $strWhere;
	}
		if($table=="certificados_solicitud_tr_2" && $field=="stage")
	{
		$strWhere = " stage_id = 5";
		return $strWhere;
	}
		if($table=="certificados_solicitud_tr_3" && $field=="stage")
	{
		$strWhere = " stage_id = 4";
		return $strWhere;
	}
		if($table=="certificados_solicitud_tr_6" && $field=="stage")
	{
		$strWhere = " stage_id = 3";
		return $strWhere;
	}
		if($table=="certificados_solicitud Report" && $field=="stage")
	{
		$strWhere = " stage_id = 1";
		return $strWhere;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="tickets" && $field=="ticket")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).(chr(rand(ord("A"), ord("Z")))).strftime("%y").mt_rand(300000,999999); ;
	}
				if($table=="tickets" && $field=="estado")
	{
		return 1;
	}
				if($table=="tickets" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="camerfirma_104_users_gestion" && $field=="active")
	{
		return 1;
	}
				if($table=="certificados_solicitud" && $field=="stage")
	{
		return 1;
				...
				if($table=="certificados_solicitud_tr_0" && $field=="track_usr")
	{
		return $_SESSION["UserID"];
	}
				if($table=="certificados_solicitud_tr_0" && $field=="track_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="certificados_solicitud_tr_1" && $field=="track_usr")
	{
		return $_SESSION["UserID"];
	}
				if($table=="certificados_solicitud_tr_1" && $field=="track_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="certificados_solicitud_tr_2" && $field=="track_usr")
	{
		return $_SESSION["UserID"];
	}
				if($table=="certificados_solicitud_tr_2" && $field=="track_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="certificados_solicitud_tr_3" && $field=="track_usr")
	{
		return $_SESSION["UserID"];
	}
				if($table=="certificados_solicitud_tr_3" && $field=="track_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="certificados_solicitud_tr_4" && $field=="track_usr")
	{
		return $_SESSION["UserID"];
	}
				if($table=="certificados_solicitud_tr_4" && $field=="track_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="certificados_solicitud_tr_4" && $field=="tk_fecha_i")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="certificados_solicitud_tr_5" && $field=="track_usr")
	{
		return $_SESSION["UserID"];
	}
				if($table=="certificados_solicitud_tr_5" && $field=="track_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="certificados_solicitud_tr_6" && $field=="track_usr")
	{
		return $_SESSION["UserID"];
	}
				if($table=="certificados_solicitud_tr_6" && $field=="track_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="certificados_solicitud Report" && $field=="stage")
