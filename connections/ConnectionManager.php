...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "sgiysp_at_127_0_0_1";
		$data["connName"] = "camerfirma at 127.0.0.1";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;127.0.0.1;root;1qaz2wsx;;camerfirma;;1"; //currently unused

		$this->_connectionsIdByName["camerfirma at 127.0.0.1"] = "sgiysp_at_127_0_0_1";
		...
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "camerfirma";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 8.0 Unicode Driver};Server=127.0.0.1;Uid=root;Pwd=1qaz2wsx;Database=camerfirma;OPTION=3";
		// encription set
		...
		$connectionsData["sgiysp_at_127_0_0_1"] = $data;
