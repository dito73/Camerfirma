...
require_once("include/certificados_tipo_q_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "certificados_tipo_q" );
